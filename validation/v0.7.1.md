# Runner v0.7.1 release evidence
...
- Package: `Runner-v0.7.1-windows-x64.zip`
...
- Extracted `Runner.exe` and `run.bat` launch diagnostics from an unrelated directory: passed
