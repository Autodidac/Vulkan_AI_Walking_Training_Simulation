...
**Release state:** CACHED AND OPEN — intentionally separated from the v0.7.23 rounded-outline hotfix because equipment changes policy dimensions and checkpoint compatibility.
