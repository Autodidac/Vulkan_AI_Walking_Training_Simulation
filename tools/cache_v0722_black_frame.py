...
heading = '# Runner v0.7.22 black-frame rendering hotfix\n'
if heading not in text:
    section = '''# Runner v0.7.22 black-frame rendering hotfix
...
text = text.replace('# Runner v0.7.22 equipment, carry, and target curriculum',
                    '# Runner v0.7.23 equipment, carry, and target curriculum')
text = text.replace('intentionally separated from the v0.7.21 readable rig/gait release',
                    'intentionally separated from the v0.7.22 rendering hotfix')
path.write_text(text, encoding='utf-8', newline='\n')
print('Runner v0.7.22 black-frame missions cached')
